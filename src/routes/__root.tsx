...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Al-Bahr Global Gateway is a full-stack web application for international travel and visa services." },
      { property: "og:description", content: "Al-Bahr Global Gateway is a full-stack web application for international travel and visa services." },
      { name: "twitter:description", content: "Al-Bahr Global Gateway is a full-stack web application for international travel and visa services." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6f389d1d-b079-439e-b730-2484391ec8f4/id-preview-a2ae9e40--71ef04de-eff2-4a33-8029-5520421fc650.lovable.app-1780420273916.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6f389d1d-b079-439e-b730-2484391ec8f4/id-preview-a2ae9e40--71ef04de-eff2-4a33-8029-5520421fc650.lovable.app-1780420273916.png" },
    ],
