...
// Comprehensive worldwide list. Israel is intentionally and permanently excluded.
...
// Back-compat aliases — both now point to the full worldwide list (Israel excluded).
export const COUNTRIES: Country[] = WORLD_COUNTRIES;
export const EU_COUNTRIES: Country[] = WORLD_COUNTRIES;
