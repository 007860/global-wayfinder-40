...
// Comprehensive country list — Israel intentionally excluded.
...
export const EU_COUNTRIES: Country[] = WORLD_COUNTRIES.filter((c) =>
  [
    "GB","IE","DE","FR","IT","ES","PT","NL","BE","CH","AT","SE","NO","DK","FI",
    "PL","CZ","HU","GR","RO","BG","HR","RS","CY","MT",
  ].includes(c.code),
);
